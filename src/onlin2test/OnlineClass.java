...
public class OnlineClass extends JFrame{
    ...
    public OnlineClass(JLabel[] arrayOfLabals, JPanel parentPanal, JLabel firstPlayerScore, JLabel secondPlayerScore, JLabel pressedLabel, int XOCounter,JLabel tieScore) {
    ...
    int randomNumber;
     ...
     public boolean isOnePlayerGameEnds() {
        ...
        if (pressedLabel.getText().equals("")) {
            ...
            XOCounter++;
           /*  if ( isGameEnds == true||XOCounter == 9 ) {
                 if(firstPlayer > Integer.valueOf(firstPlayerScore.getText())){
                     return firstplayer win;
                 
                 }
                 else if(secondPlayer > Integer.valueOf(secondPlayerScore.getText())){

...
public class OnlineBoard extends JFrame {
   ...
   public static JLabel firstPlayerName;
    ...
    private boolean isOnePlayerGameEnds(JLabel pressedLabel) {
        //check all game
        boolean check = false;
        //firstPlayerScore = win/secondPlayerScore=lose/pressedLabel=my pressed my move/XOCounter=label counter
        OnlineClass e = new OnlineClass(arrayOfLabals, parentPanal, firstPlayerScore, secondPlayerScore, pressedLabel, XOCounter,tieScore);
 ...
 ///when pressed label send it to isOnePlayerGameEnds()
            if (isGameEnds == false) {
